...
(4) Make sure the target board is in ISP mode
(5) Plug the USB cable to power on,waiting for conneted to server,
    LCD would display the network status
(6) Press the button SW2 to start Porogram
